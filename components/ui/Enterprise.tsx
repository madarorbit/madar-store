...
export function OrbyBadge({imageSrc='/brand/orby-assistant.svg',label='أوربي'}:{imageSrc?:string;label?:string}){return <span className="md-orby-chip"><img src={imageSrc} alt="صورة أوربي" className="md-orby-avatar"/><span>{label}</span></span>}
