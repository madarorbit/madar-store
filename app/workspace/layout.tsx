...
const links=[['/workspace','نظرة عامة'],['/workspace/analytics','التحليلات'],['/workspace/setup','الإعداد'],['/workspace/imports','الاستيراد'],['/workspace/products','المنتجات'],['/workspace/inventory','المخزون'],['/workspace/customers','العملاء'],['/workspace/sales','المبيعات'],['/workspace/expenses','المصروفات'],['/workspace/suppliers','الموردون'],['/workspace/tasks','المهام']];
