...
export default function RootLayout({children}:Readonly<{children:React.ReactNode}>){return <html lang="ar" dir="rtl" className="h-full scroll-smooth antialiased"><body className="flex min-h-full flex-col"><PlatformStatusBar/><CartProvider>{children}</CartProvider></body></html>}
